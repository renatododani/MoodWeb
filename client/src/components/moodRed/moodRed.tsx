...
export function RedMood() {
  ...
  return (
    <div className="moodRed">
      <h1 className="red-header">Anger, Frustration, Passion</h1>
      <div className="quote">
      ...
      <div className="books-container">
        ...
        <div className="name-description">
          ...
          <p className="book-description">
            A classic narrative about Africa's cataclysmic encounter with Europe
            as it establishes a colonial presence on the continent. Told through
            the fictional experiences of Okonkwo, a wealthy and fearless Igbo
            warrior of Umuofia in the late 1800s.
          </p>
        </div>
      </div>
