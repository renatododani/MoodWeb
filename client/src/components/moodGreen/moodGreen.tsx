...
import { getGreenBooks, Book } from "../../service/getBooks";
import { getGreenMovies, Movie } from "../../service/getMovies";
...
export function GreenMood() {
  ...
  useEffect(() => {
    ...
    getGreenBooks().then((data) => setBook(data));
    getGreenMovies().then((data) => setMovie(data))
  }, []);
  return (
    <div className="moodGreen">
      <h1 className="green-header">Happy, Content</h1>
    <div className="quote">
