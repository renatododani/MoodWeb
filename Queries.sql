...
insert into books (color,img,title,author,description) values ('purple','purple3.jpg','The Right Swipe','Alisha Rai','Meet Rhiannon, the creator of a hot dating app who tries to follow her own rules for hooking up. She’s ghosted by a hottie, but when he reemerges asking for a second chance, she has to revise her own rules. Readers love Alisha Rai’s latest novel for its modern, multicultural romance filled with wit and fire.');
